# Two-Grain Validation Test: 0° vs 90° Rotation
# Clean setup with global + per-grain output
#
# Expected behavior:
# - Elastic: Same average stress, different strains
# - Yield: Grain 2 first (~4100 MPa in material frame)
# - Plastic: Load redistribution, different stress evolution
...
[Materials]
  #========================================
  # GRAIN 1: Baseline orientation (0,0,0)
  # Loads material X-axis → σ_xx_tension = 4980 MPa
  #========================================
  [elasticity_grain1]
  ...
  #========================================
  # GRAIN 2: 90° rotation around Z-axis
  # Loads material Y-axis → σ_yy_tension = 4100 MPa (18% weaker)
  #========================================
  [elasticity_grain2]
    type = ComputeElasticityTensor
    fill_method = symmetric9
...
[Outputs]
  ...
  [exodus]
    type = Exodus
    file_base = two_grain_simple_out
