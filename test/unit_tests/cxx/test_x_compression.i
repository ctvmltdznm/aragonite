# Unit Test: X-Compression
# Expected: Yield at -4980 MPa (or user-defined compression strength)
...
[BCs]
  ...
  [compress_x]
    ...
    variable = disp_x
    boundary = 'right'
    function = '-0.001*t'  # Negative = compression
  []
[]
...
[Outputs]
  csv = true
  file_base = x_compression_out_linear_perfect
