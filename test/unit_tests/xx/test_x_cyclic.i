# Unit Test: X-Cyclic Loading
# Load to max strain, then unload
# Expected: Plastic strain remains after unloading
...
[BCs]
  ...
  [cyclic_x]
    ...
    variable = disp_x
    boundary = 'right'
    function = 'if(t<=45, 0.001*t, 0.001*(90-t))'  # Load to t=55, unload to t=10
  []
[]
...
[Outputs]
  csv = true
  file_base = x_tension_out_cyclic_exp_softening
