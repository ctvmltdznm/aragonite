# Unit Test: Z-Tension
# Expected: Yield at 5340 MPa, soften to 3738 MPa
...
[BCs]
  ...
  [pull_z]
    ...
    variable = disp_z
    boundary = 'front'
    function = 'if(t<=120, 0.001*t, 0.001*(240-t))'  # Load to t=55, unload to t=10
  []
[]
...
[Outputs]
  csv = true
  file_base = z_tension_out_cyclic_piecewise_softening
