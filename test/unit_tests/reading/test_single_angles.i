# Unit Test: X-Tension
# Expected: Yield at 4980 MPa, soften to 3486 MPa
...
[Materials]
  [elasticity]
    type = ComputeElasticityTensorCoupled #ComputeElasticityTensor
    fill_method = symmetric9
    C_ijkl = '171800 57500 30200 106700 46900 84200 42100 31100 46600'
    coupled_euler_angle_1 = euler1  # Couple to AuxVariable
    coupled_euler_angle_2 = euler2
    coupled_euler_angle_3 = euler3
  []
  ...
  [plasticity]
    ...
    residual_strength = 0.7  # instead of rdy/gmin - unified parameter
    kmax = 0.001
    kmin = 0.02
    kslope = 30.0
    ...
    euler_angle_1 = euler1  # Couple to AuxVariable
    euler_angle_2 = euler2
    euler_angle_3 = euler3
  []
[]
...
[Outputs]
  csv = true
  file_base = x_tension_out_linear_piecewise_softening
