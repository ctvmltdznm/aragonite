# x_compression.i
# Asymmetric response validation - X-direction uniaxial tension
# Expected: E_1 = 140.4 GPa, σ_xx^yield shifted based on linear term in yield surface formulation
...
[Materials]
  ...
  [plasticity]
    ...
    sigma_xx_compression = 3900
    sigma_yy_compression = 3100
    sigma_zz_compression = 4400
